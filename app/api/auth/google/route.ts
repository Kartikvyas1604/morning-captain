...
export async function GET() {
  ...
  if (!isProviderConfigured(provider)) {
    return new Response(
      setupPage("google", "Google",
        `<ol>
          <li>Go to <a href="https://console.cloud.google.com/apis/credentials">Google Cloud Console → Credentials</a></li>
          <li>Create an OAuth 2.0 Client ID (Web application)</li>
          <li>Add <code>http://localhost:3000/api/auth/google/callback</code> as an Authorized redirect URI</li>
