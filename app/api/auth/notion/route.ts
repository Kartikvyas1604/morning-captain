...
export async function GET() {
  ...
  if (!isProviderConfigured(provider)) {
    return new Response(
      setupPage("notion", "Notion",
        `<ol>
          <li>Go to <a href="https://www.notion.so/profile/integrations">Notion → My Integrations</a></li>
          <li>Create a new Internal Integration</li>
          <li>Set redirect URI to <code>http://localhost:3000/api/auth/notion/callback</code></li>
